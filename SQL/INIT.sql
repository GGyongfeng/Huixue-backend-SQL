...
CREATE TABLE staff (
    ...
    role ENUM('admin', 'manager', 'staff', 'visitor') NOT NULL DEFAULT 'visitor' COMMENT '用户角色',
...
CREATE TABLE tutor_orders (
    ...
    student_grade ENUM('幼儿', '小学', '初一', '初二', '初三', '高一', '高二', '高三','成人','其他') NOT NULL COMMENT '年级',
    subjects SET('语文', '数学', '英语', '物理', '化学', '生物', '历史', '地理', '政治', '国际课程', '其他') NOT NULL COMMENT '科目',
    teacher_type ENUM('在职老师', '985学生') NULL COMMENT '教师水平要求',
    teacher_gender ENUM('男', '女') NULL COMMENT '教师性别要求',
    order_tags TEXT NULL COMMENT '订单标签（多个标签用逗号分隔）',
    ...
    phone_number VARCHAR(20) NULL COMMENT '联系方式',
